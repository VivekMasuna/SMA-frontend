...
const Quiz2 = () => {
  ...
  const questions = [
    {
      questionText: "Which Python library is commonly used to extract data from HTML and XML documents?",
      options: [
        "Requests",
        "Pandas",
        "BeautifulSoup",
    ...
    {
      questionText: "What is the main purpose of the Requests library in Python?",
      options: [
        "To parse HTML content",
        "To send HTTP requests and retrieve data from web pages",
        "To visualize graphs",
        "To create GUIs"
      ],
      correctAnswer: 1
    ...
    {
      questionText: "Which method provides the most structured and official way to collect social media data?",
      options: [
        "Manual copy-paste",
    ...
    {
      questionText: "What is Scrapy mainly used for?",
      options: [
        "Creating machine learning models",
        "High-performance web scraping and crawling large websites",
        "Running unit tests",
    ...
    {
      questionText: "Which of the following is a potential risk while scraping websites without using official APIs?",
      options: [
        "Cleaner data formats",
        "Getting paid datasets for free",
        "Legal or ethical issues and being IP-blocked",
